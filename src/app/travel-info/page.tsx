                ...
                culture: {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            icon: Globe,
                            content: [
                                "호텔 체크인: 아침 일찍 도착해서 배낭만 맡기고 체크인 시간에 정식 체크인 하는 방법이 좋습니다",
                                "환풍기 필수: 체크인 할 때 환풍기는 꼭 켜주세요. 습도가 높아서 곰팡이가 생길 수 있습니다",
                                "화장실 습도 관리: 화장실 문을 닫지 말고 열어두면 습기가 덜 쌓입니다",
                                "바베큐 장소 선택: 바베큐를 즐기시면 스크린이 있어서 바퀴벌레나 모기 등이 들어오지 않는 곳이 좋습니다",
                            ],
                        },
                        {
                            title: "음식 보관 및 관리 팁",
                            icon: Globe,
                            content: [
                                "냉동 식품 보관: 냉동 식품을 사면 보냉백과 얼음이 들어가 있는데, 얼음은 얼어있을 수 있습니다. 전용용기에 옮겨 넣으면 더 오래 갑니다",
                                "레몬 보관: 고등어회를 즐기시면 레몬을 냉장고에 보관할 때는 랩을 씌워주면 좋습니다",
                                "호텔/에어비엔비 초콜릿: 호텔/에어비엔비에는 보통 초콜릿이 있는데, 모두 찾아서 밤에 먹어주세요. 아이들이 그 다음날 아침에 발견하면 모두 먹으려고 할 수 있습니다",
                            ],
                        },
                        {
                            title: "공항 및 쇼핑 팁",
                            icon: Globe,
                            content: [
                                "공항 물 구매: 해외에서는 공항에서 물 사는 게 가장 비쌉니다",
                            ],
                        },
                    ],
                },
